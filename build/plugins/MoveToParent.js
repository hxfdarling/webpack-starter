function MoveToParent(chunkCount) {
	this.chunkCount = chunkCount || 2;
}
module.exports = MoveToParent;

MoveToParent.prototype.constructor = MoveToParent;
...
MoveToParent.prototype.apply = function(compiler) {
		...
		compilation.plugin("optimize-chunks", function(chunks) {
			...
			for (var key in modules) {
				...
				if (handle.chunks.length >= chunkCount) {
					...
					if (parent) {
						handle.chunks.forEach(function(chunk) {
